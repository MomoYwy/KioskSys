...
import static salesManager.SupplierEntry.SUPPLIERS_FILE;
...
public class ViewSupplierEntry extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSupplierEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSupplierEntry().setVisible(true);
            }
        });
    }
