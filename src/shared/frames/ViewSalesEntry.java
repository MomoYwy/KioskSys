...
public class ViewSalesEntry extends javax.swing.JFrame {
    ...
    public ViewSalesEntry() {
        ...
        // Load data when frame is created using the utility method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSalesEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSalesEntry().setVisible(true);
            }
        });
    }
